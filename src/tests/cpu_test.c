/*
 * cpu_test.c - Legacy 6502 instruction tests
 *
 * Author: @frankischilling
 *
 * This file contains the older instruction level test harness for individual 6502
 * operations, addressing modes, flags, branches, stack operations, and register transfers.
 *
