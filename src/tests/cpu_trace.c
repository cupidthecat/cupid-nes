/*
 * cpu_trace.c - Canonical CPU trace comparison
 *
 * Author: @frankischilling
 *
 * This file loads a diagnostic ROM and compares each executed CPU state against a canonical
 * instruction trace, including registers, program counters, opcodes, and cycle positions.
 *
