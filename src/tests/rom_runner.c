/*
 * rom_runner.c - Diagnostic ROM test runner
 *
 * Author: @frankischilling
 *
 * This file runs external diagnostic ROMs with bounded execution, controller input,
 * reset handling, result protocol checks, framebuffer output, and AccuracyCoin reporting.
 * Timeouts and incomplete result protocols are treated as failures.
 *
