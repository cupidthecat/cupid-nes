/*
 * mapper_accuracy_nintendo.h - Nintendo mapper regression tests
 *
 ...
 */
#ifndef MAPPER_ACCURACY_NINTENDO_H
#define MAPPER_ACCURACY_NINTENDO_H
...
#endif // MAPPER_ACCURACY_NINTENDO_H
