/*
 * mapper_accuracy_discrete.h - Discrete mapper regression tests
 *
 ...
 */
#ifndef MAPPER_ACCURACY_DISCRETE_H
#define MAPPER_ACCURACY_DISCRETE_H
...
#endif // MAPPER_ACCURACY_DISCRETE_H
