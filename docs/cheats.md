...
Use **Tools > Cheats > Add cheat** to enter a code. Invalid codes stay in the
editor with an explanation. The Cheats panel also lets you enter a description,
select an existing code, and change its enabled state. **Load cheat file** and
**Save cheat file** open file choosers; canceling them leaves the list unchanged.
