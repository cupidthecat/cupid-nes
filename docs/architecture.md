...
| [src/rom/mapper.c](../src/rom/mapper.c) and its `mapper_*.inc` fragments | Shared cartridge state, board selection, banking, cartridge RAM, nametables, interrupts, and persistence |
